...
[code](https://root.cern/doc/master/canvas2_8C.html) The Divide() method is not appropriate to divide a Canvas. Because of the left and right margins, all the pads do not have the same width and height.
