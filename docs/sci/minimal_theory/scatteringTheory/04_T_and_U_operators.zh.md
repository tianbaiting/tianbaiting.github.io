# ch04 从波算符到 T 算符，再到三体 AGS 的 U 算符
...
## 从通道 Lippmann-Schwinger 方程定义 U_{\beta\alpha}

### 通道形式的 Lippmann-Schwinger 方程
