...
## Definition of tensor polarization
...
## Polarized differential scattering cross section
...
### Monitoring $p_{y'y'}$ (existing method)
...
### Monitoring $p_{z'z'}$ (proposed in this work)
...
## Polarimeter design and simulation results
...
### Spin preservation through single-turn cyclotron extraction
...
## Determining the polarization axis with polarimeters at multiple positions
...
### Cross section for an arbitrary polarization axis
...
### Multi-position polarimeter scheme
...
### Why an intermediate magnetic field is essential
...
## Combined vector and tensor polarization
...
### Lifting the degeneracy with two polarimeters
...
### Complementarity with the spin-flip technique
