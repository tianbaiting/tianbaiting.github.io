...
找到![1746813908270](assets/sw-api.zh/1746813908270.png)![1746814173261](assets/sw-api.zh/1746814173261.png)，就会出现如下代码，便能在6DD4B124-4733-4DFF-97A8-52F70924D514x0x31x0.py文件里找到。 该makepy生成了要用到的宏文件的定义
